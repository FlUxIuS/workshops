...
class decode_OOK_file(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Decode Ook File")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Decode Ook File")
        ...
        self.settings = Qt.QSettings("GNU Radio", "decode_OOK_file")
        ...
        # Variables
        ##################################################
        self.treshold_low = treshold_low = -0.2
        self.treshold_high = treshold_high = -.1
        ...
        self.blocks_wavfile_sink_0_0 = blocks.wavfile_sink('demoduled_file.wav', 1, int(samp_rate), 8)
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink('moduled_complex_file_read.wav', 1, int(samp_rate), 8)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/fluxius/OOK_gen_inputfile.cfile', False)
...
def main(top_block_cls=decode_OOK_file, options=None):
