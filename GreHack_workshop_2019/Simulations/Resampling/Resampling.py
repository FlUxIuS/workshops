...
# Title: Resamping effects
# Author: Sébastien Dudek (@FlUxIuS)
# Description: Observe the effect of resampling
# Generated: Mon Nov 18 18:40:07 2019
##################################################
...
class Resampling(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Resamping effects")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Resamping effects")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Resampling")
        ...
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, 1, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0_0, 0), (self.rational_resampler_xxx_0_0_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_0_0_0, 0), (self.blocks_throttle_0_0_0, 0))
...
def main(top_block_cls=Resampling, options=None):
